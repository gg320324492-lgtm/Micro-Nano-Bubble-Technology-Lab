  ...
  if (redesignedSlugs.has(item.slug)) {
    ...
    > = {
      ...
      "不同气源微纳米气泡对水中小球藻的抑制效果及作用机理": {
        summary:
          "研究表明，空气、氮气和臭氧微纳米气泡对水中小球藻进行短暂原位处理（5-40 min）后均能显著抑制藻类生长。处理后 120 h，平均藻密度为 8.12-17.63×10^6 cells/mL，较对照组平均抑制率为 24.17%-63.09%，且抑制作用随处理时间延长逐步增强。O₃ MNBs 抑藻效果最优，40 min 处理并静置 24 h 后除藻率最高可达 81.10%，分别较 air 与 N₂ 气源高 21.49% 和 22.79%。",
        sections: [
          {
            id: "bo-module-1-section-1",
            label: "处理效果与关键指标",
            content:
              "研究表明，不同气源（空气、氮气、臭氧）微纳米气泡短时原位处理（5-40 min）均可显著抑制小球藻生长。处理后 120 h，平均藻密度为 8.12-17.63×10^6 cells/mL，较对照组平均抑制率为 24.17%-63.09%，并随处理时间增加而持续增强。O₃ MNBs 表现最优，40 min 处理并静置 24 h 后除藻率达到 81.10%，较 air 与 N₂ 分别提高 21.49% 与 22.79%。",
          },
          {
      ...
      "臭氧微纳米气泡对水中四环素的高效降解": {
        summary:
          "本研究围绕臭氧微纳米气泡（O₃-MNBs）强化四环素氧化过程，系统解析传质强化、活性氧生成、动力学行为与产物转化机制。相较传统臭氧曝气，O₃-MNBs 可形成 5.25-7.17×10^7 bubbles/mL 的高密度气泡群（95% 分布于 50-1200 nm，Zeta 电位为 -4.71~-13.65 mV），使稳态溶解臭氧浓度提高 2.57-4.33 倍、峰值浓度提高 85.50%，并显著延缓停曝后臭氧衰减；同时 ·OH 生成量提高 2.3 倍，平均自由基浓度达 21.49 μmol/L。四环素在 120 s 内去除率达到 96.25%，较传统体系提升 81.25%，且传统体系表观速率仅为该体系的 7.14%，体现出显著深度氧化优势。",
        sections: [
          {
