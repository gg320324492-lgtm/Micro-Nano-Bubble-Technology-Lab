...
const WATER_COPY = {
  ...
  module2:
    "在耐受性微生物控制方面，MNBs 对耐氯蜡样芽孢杆菌表现出优异的灭活能力。其中，臭氧微纳米气泡（O₃-MNBs）处理 10 min 后，对蜡样芽孢杆菌的灭菌率可达 90% 以上，显示出其在饮用水安全保障与强化消毒中的良好应用潜力。",
  module3:
  ...
  module4:
    "在此基础上，团队进一步完成了微纳米气泡与紫外协同消毒的关键预实验验证。结果表明，自研 MNBs 体系可稳定生成浓度为 2.67×10⁶ bubbles/mL、平均粒径为 397 nm、Zeta 电位为 -10.26 mV 的微纳米气泡体系，具有良好的分散性与停留特性，能够满足饮用水消毒过程需求。",
  module5:
  ...
  module6:
    "在消杀效能方面，针对初始浓度为 10⁷-10⁸ CFU/mL 的蜡样芽孢杆菌，MNBs/UV 联合体系平均杀菌率达到 78.37%，较单独 UV 提升 31.92%；在最优参数条件下，处理 1 min 的杀菌率即可达到 97.21%，展现出显著的协同增效优势。",
  conclusion:
...
export default async function ResearchDetailPage(props: PageProps) {
  ...
  const coverFocusY =
    typeof item.coverFocusY === "number" ? item.coverFocusY : 35;
  ...
  const gallery: GalleryItem[] = images.map((g) => ({
    ...
    alt: g.alt,
    caption: g.captionZh,
    focusY: typeof g.focusY === "number" ? g.focusY : 40,
  }));
                      ...
                      sections: [
                        {
                          ...
                          label: "处理效果与关键指标",
                          content:
                            "不同气源（N₂、空气、O₂、O₃）微纳米气泡均可提升二次供水生物稳定性。对 BDOC、AOC 和总菌的平均降解率分别达到 42.74%、49.49% 和 51.32%，其中空气气源在有机物去除与杀菌效率方面表现更优。研究同时观察到总菌变化相对营养物质变化存在约 3 周滞后，且处理后浊度、TDS 下降、DO 上升，整体水质明显改善。",
                        },
                        {
                          id: "water-module-1-section-2",
                          label: "微生物群落机制解析",
                          content:
                            "群落分析表明，微纳米气泡可同时作用于“菌群结构-功能代谢-营养基质”三条路径：一方面对 Proteobacteria、Planctomycetota 等关键类群具有显著抑制作用，其中 Acinetobacter 去除率可达 100%；另一方面通过提升氧化胁迫水平（尤其在 O₂-MNBs 下），促进 ·OH 对脂质、蛋白质与核酸的氧化损伤，抑制转录与代谢功能。与此同时，气泡溃灭生成的 ·OH 可降解有机质，进一步削弱微生物营养来源与再生能力。",
                        },
                      ],
                      images: [
                        {
                    ...
                    },
                    {
                      ...
                      sections: [
                        ...
                        },
                        {
                          ...
                          content:
                            "入侵后采用微纳米气泡处理可快速恢复水质：浊度与 TDS 分别下降 53.95% 和 8.46%，DO 提升 11.12%。其中 O₃-MNBs 对浊度恢复最优（0.42 NTU），O₂-MNBs 对 DO 提升最优（11.84 mg/L）。同时总菌数下降 66.53%，并通过降低异常富集、重塑群落多样性来抑制大肠杆菌优势化，实现水质与生态双重恢复。",
                        },
                      ],
                      images: [
                        {
                      ...
                      sections: [
                        {
                          ...
                          content:
                            "研究在末端管道水力条件下构建生物膜形成模型，并划分为缓慢生长（0-27 d）、快速生长（27-42 d）和动态稳定（42-66 d）三个阶段。结果显示，MNBs 在前两阶段抑膜作用最显著，O₂-MNBs 条件下生物膜干重最高可降低 77.87%。机理上，SP 阶段以物理阻隔与化学氧化为主，RP 阶段以氧化失活为主，DP 阶段则由吸附-冲刷过程主导。",
                        },
                        {
                          id: "water-module-1-card3-section-2",
                          label: "物理—化学协同机制与水质效应",
                          content:
                            "MNBs 通过“物理冲击 + 化学氧化”协同抑制生物膜：可降低 EPS 含量、改变膜层形貌并重塑优势菌结构，关键菌 Planctomycetes 灭活率达到 54.22%-61.66%。在 O₂-MNBs 条件下，早中期抑膜最明显。水质层面，处理后浊度下降 24.53%、DO 提升 18.8%、TOC 降解率达 87.93%。总体上，MNBs 可同时削弱附着生长与营养支撑，降低不可逆粘附风险，具备管网生物膜控制与水质保障的应用潜力。",
                        },
                      ],
                      images: [
                        {
                      ...
                      sections: [
                        {
                          ...
                          label: "处理效果与形貌证据",
                          content:
                            "研究表明，空气、氮气和臭氧微纳米气泡均可有效灭活蜡样芽孢杆菌。在处理 1 min 后，细菌的平均灭活率为 60.09%，且灭活效率随处理时间延长逐渐提高。经过 9 min 处理，空气 MNBs 对蜡样芽孢杆菌的灭活效率达到 84.77%；而 O₃ 与 N₂ MNBs 的灭活效率均超过 99%，表现出更显著的强化消毒效果。显微形貌观察显示，不同气源 MNBs 处理后，细菌细胞出现明显拉伸、皱缩、凹陷、凸起、裂缝、鞭毛分离及内容物泄漏等现象。",
                        },
                        {
                      ...
                      sections: [
                        {
                          ...
                          label: "体系构建与反应物种转化机制",
                          content:
                            "研究开发了 MNBs 与次氯酸钠（NaClO）组合体系，并以大肠杆菌为指示菌评估消毒性能与增强机制。结果显示，NaClO 的加入使水中 MNBs 平均浓度降低 24.56%，平均粒径在 400~800 nm 范围内发生重构；Zeta 电位绝对值由 21.97 mV 降至 11.58 mV（下降 47.29%），说明气泡间静电排斥减弱并促进破裂释能。MNBs 中 ·OH 峰值浓度可达 873.37 μmol/L；加入 NaClO 后，·OH 平均浓度下降 71.53%，但反应物种转化为 Cl· 与 Cl₂·⁻ 等反应性氯自由基（RCS），实现氧自由基向氯自由基的动态转化。在 0.6~0.9 mg/L 氯浓度下，反应物种产生保持稳定，体系呈现连续氧化通量。",
                        },
                        {
                          id: "water-module-3-section-2",
                          label: "灭活效能、副产物控制与综合结论",
                          content:
                            "单独 NaClO 的对数杀菌率为 0.39-log~2.22-log；引入 MNB 后提升至 3.44-log（提升 129%），且将 MNBs 曝气时间由 5 min 延长至 10 min 可进一步提高失活水平。MNB/NaClO 体系显著增强离子渗漏（K⁺、Ca²⁺、Na⁺、Mg²⁺），总渗漏体积较单独 NaClO 提高 134%，并促进蛋白质与 DNA 泄漏。自由基清除实验表明贡献顺序为 ·OH > H₂O₂ > ·NO > ·O₂⁻；去除 ·OH 后杀菌率下降 47.08%，说明 ·OH 为主导反应物种。与此同时，MNBs 还能有效抑制 DBP 形成，三氯甲烷（TCM）由 2.97 mg/L 降至 1.79 mg/L（降低 40%），在高氯条件（0.9~1.2 mg/L）下降幅最高可达 68%。总体上，MNBs/NaClO 通过“物理干扰 + 界面活化 + 化学氧化”协同，实现高效消毒与副产物风险控制。",
                        },
                      ],
                      images: [
                        {
  ...
  if (redesignedSlugs.has(item.slug)) {
    ...
    > = {
      ...
      "不同气源微纳米气泡对水中小球藻的抑制效果及作用机理": {
        summary:
          "研究表明，空气、氮气和臭氧微纳米气泡对水中小球藻进行短暂原位处理（5-40 min）后均能显著抑制藻类生长。处理后 120 h，平均藻密度为 8.12-17.63×10⁶ cells/mL，较对照组平均抑制率为 24.17%-63.09%，且抑制作用随处理时间延长逐步增强。O₃ MNBs 抑藻效果最优，40 min 处理并静置 24 h 后除藻率最高可达 81.10%，分别较 air 与 N₂ 气源高 21.49% 和 22.79%。",
        sections: [
          {
            id: "bo-module-1-section-1",
            label: "处理效果与关键指标",
            content:
              "研究表明，不同气源（空气、氮气、臭氧）微纳米气泡短时原位处理（5-40 min）均可显著抑制小球藻生长。处理后 120 h，平均藻密度为 8.12-17.63×10⁶ cells/mL，较对照组平均抑制率为 24.17%-63.09%，并随处理时间增加而持续增强。O₃ MNBs 表现最优，40 min 处理并静置 24 h 后除藻率达到 81.10%，较 air 与 N₂ 分别提高 21.49% 与 22.79%。",
          },
          {
            id: "bo-module-1-section-2",
            label: "作用机制解析",
            content:
              "基于加压溶气释气法生成的高密度 MNBs 进入水体后可增强细胞-气泡接触，气泡溃灭产生微流、压力波、微射流与 ROS，对藻细胞形成物理-化学协同作用。SEM 结果显示细胞表面发生明显收缩、破裂及碎片化；同时 ·OH、H₂O₂、·O₂⁻ 诱导氧化胁迫，导致 SOD、CAT、类胡萝卜素、MDA 分别增加 88%、113%、11%、67%，并使叶绿素 a、b 分别下降 19% 与 45%，最终抑制藻细胞持续生长。",
          },
        ],
        images: [
          {
      ...
      "水介质中臭氧微纳米气泡对含油污泥的破乳作用": {
        summary:
          "油泥是石油工业中产生的复杂乳化态废弃物，含有大量有毒有害物质。研究表明，O₃ MNBs 具有优异理化特性：气泡直径 831 nm，水中 ·OH 浓度 250.4 μmol/L；与常规曝气（5.6 mg/L）相比，O₃ MNBs 水中臭氧浓度提升至 16.4 mg/L（增加 192%）。不同气源 MNBs 均可有效破乳含油污泥，其中 O₃ MNBs 除油率最高达 41.5%，并显著削弱烷烃 C-H 吸收峰，降低固相碳元素、提高氧元素占比，体现出更强的氧化重构能力。",
        sections: [
          {
            id: "bo-module-2-section-1",
            label: "处理效果与关键指标",
            content:
              "O₃ MNBs 可显著强化水-油-固三相分离过程，提高除油率并改善水质指标。实验显示，不同气源 MNBs 均能实现破乳，其中 O₃ MNBs 效果最佳（除油率 41.5%），在油分配优化、COD/TOC 控制及 ORP、pH 调整方面均表现出优势。",
          },
          {
            id: "bo-module-2-section-2",
            label: "作用机制解析",
            content:
              "O₃ MNBs 通过“物理冲击 + 化学氧化”协同破乳：气泡破裂产生冲击波与微射流促进油滴脱附和界面破裂；同时 O₃ 与 ·OH 强氧化作用诱导石油烃断链与亲水化，增强油相与固相分离并促进污染物降解。谱学与热分析结果进一步表明，处理后烷烃特征峰减弱、轻重组分热失重行为改变，验证了油泥有机组分的结构重构与氧化转化。",
          },
        ],
        images: [
          {
      ...
      "臭氧微纳米气泡活化H₂O₂促进甲苯高效治理": {
        summary:
          "在低浓度甲苯治理方面，O₃-MNBs与H₂O₂构建的无催化剂水相氧化体系表现出良好的甲苯去除与深度氧化潜力。研究表明，该体系能够通过强化气液传质，并促进·OH 与O₂·⁻ 等活性氧生成，从而提升甲苯的转化与矿化水平。整体来看，该体系在持续运行过程中保持了较好的反应稳定性，并体现出一定的深度氧化能力。此外，其对pH波动、水基质变化及部分共存离子具有较强适应性，显示出在复杂工况下应用于低浓度甲苯治理的潜力。",
        sections: [
          {
            id: "bo-module-4-section-1",
            label: "处理效果与体系特征",
            content:
              "O₃-MNBs/H₂O₂ 体系在低浓度甲苯条件下可实现高效去除与持续稳定运行。该体系无需额外催化剂，能够通过强化气液传质并促进 ·OH 与 O₂·⁻ 等活性氧生成，提升甲苯的转化与矿化水平。实验表明，在较宽的 H₂O₂ 浓度区间和不同 O₃ 浓度下，甲苯转化率均能维持在较高水平，CO₂ 释放量随时间显著上升，体现了较为充分的深度氧化能力。",
          },
          {
            id: "bo-module-4-section-2",
            label: "作用机制与工况适应性",
            content:
              "其核心机制在于 O₃-MNBs 显著增大气液界面面积，提升 O₃ 与 H₂O₂ 在界面处的传质与反应效率，从而持续产生 ·OH、O₂·⁻ 等活性氧物种并驱动甲苯氧化矿化。体系对 pH 变化、不同水性底物（超纯水 / 自来水）、不同操作压力及多种共存阴阳离子均具有较强耐受性，活性物种淬灭实验进一步证实了 ·OH 与 O₂·⁻ 在甲苯转化过程中的主导作用，提示该技术在复杂工况下具有进一步放大的应用基础。",
          },
        ],
        images: [
          {
      ...
      "臭氧微纳米气泡对水中四环素的高效降解": {
        summary:
          "本研究围绕臭氧微纳米气泡（O₃-MNBs）强化四环素氧化过程，系统解析传质强化、活性氧生成、动力学行为与产物转化机制。相较传统臭氧曝气，O₃-MNBs 可形成 5.25-7.17×10⁷ bubbles/mL 的高密度气泡群（95% 分布于 50-1200 nm，Zeta 电位为 -4.71~-13.65 mV），使稳态溶解臭氧浓度提高 2.57-4.33 倍、峰值浓度提高 85.50%，并显著延缓停曝后臭氧衰减；同时 ·OH 生成量提高 2.3 倍，平均自由基浓度达 21.49 μmol/L。四环素在 120 s 内去除率达到 96.25%，较传统体系提升 81.25%，且传统体系表观速率仅为该体系的 7.14%，体现出显著深度氧化优势。",
        sections: [
          {
          ...
          },
          {
            ...
            label: "机制链条与产物演化",
            content:
              "该体系通过“传质强化-界面活化-多氧化剂协同”驱动污染物深度转化：气泡界面行为增强 O₃ 停留与传递，·OH 等自由基协同直接氧化；LC-MS 结果显示四环素经历脱甲基、脱羧与芳环断裂等并行路径，并持续向低 m/z、小分子、高极性产物演化，说明结构破坏更充分、潜在产物风险更低。",
          },
        ],
        images: [
          {
