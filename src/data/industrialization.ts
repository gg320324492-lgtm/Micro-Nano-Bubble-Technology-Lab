...
export const industrialBases: IndustrialBase[] = [
...

  {
    ...
    titleZh: "黑臭水体治理示范点",
    titleEn: "Urban Black-Odorous Water Remediation Pilot",
    briefZh:
      "围绕城市黑臭水体与景观水体提升，开展微纳米气泡联合生态修复的长期验证与效果评估，形成可复制的治理工艺组合与运行策略（文字待后续项目资料补充与完善）。",

    // 先占位的图片与场景介绍，后续可替换为实景照片
    cover: "/industrialization/black-odorous-water/cover.jpg",

    locationZh: "某城市黑臭水体治理示范河段（具体位置与地图链接待补充）",

    highlightsZh: [
      "典型场景：城区黑臭河道、景观湖泊及内涝易发片区的水体环境改善",
      "技术路线：微纳米曝气 + 水体循环 + 生态修复（原位/离位）的组合方案占位",
      "监测指标：溶解氧、ORP、COD、氨氮、总磷、透明度与异味感知等（待实测数据替换）",
      "工程关注：治理效果持续性、能耗水平、运维便利性与景观协同（后续根据项目总结细化）",
    ],
    ...
    sections: [
      {
        titleZh: "场地与现状概况（占位）",
        bodyZh:
          "示范点位于典型城市建成区内，受生活污水、初期雨水与底泥释放等多源影响，长期存在水体发黑发臭、透明度低、溶解氧不足等问题。本段文字为预留描述，后续将根据实际项目背景与监测结果进行替换与细化。",
      },
      {
        titleZh: "治理思路与系统构成（占位）",
        bodyZh:
          "以“控源减负—水体修复—生态重建”为主线，结合微纳米气泡曝气系统、水体循环与补水、生态浮床/挺水植物等手段，构建分阶段、可量化的治理路径。该段落现为占位说明，后续将根据工艺流程图与设备配置进行更新。",
        bulletsZh: [
          "前期调查与基线监测：水质现状、污染负荷及水动力条件调查（待补资料）",
          "工艺组合设计：曝气方式、布点原则与生态修复措施匹配（占位要点）",
          "施工与调试：设备安装、运行参数初始设定与安全防护要求（待完善）",
          "运行评估：短期响应、长期趋势及运维建议的系统性总结（后续补写）",
        ],
      },
      {
        titleZh: "示范意义与推广前景（占位）",
        bodyZh:
          "通过在复杂城市场景中的连续运行与多维指标监测，验证微纳米气泡等新型水体修复手段在黑臭水体治理中的适用性与边界条件，为后续在更多河湖与雨水调蓄设施中的工程化复制提供数据与经验支撑。本段为预留文字，后续将结合项目阶段性总结进行更新。",
      },
    ],
  },
];
