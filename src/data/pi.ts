...
export const pi: PiInfo = {
  ...
  bio:
    "王天志，天津大学环境科学与工程学院副教授（博导）、瑞德智创新技术（天津）有限公司董事长。聚焦微纳米气泡技术领域前沿研究与应用，注重理论创新与技术转化，形成“技术突破-商业转化”特色科研体系，构建了完整的微纳米气泡技术自主知识产权体系，创办企业获得天津海棠基金与天津市西青区金种子基金投资，融资 1550 万元，技术估值 7000 万元。",
