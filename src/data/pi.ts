...
export const pi: PiInfo = {
  ...
  bioZh:
    "王天志，天津大学环境科学与工程学院副教授（博导）。聚焦微纳米气泡机理与工程应用，目前主要围绕“气泡成核过程调控与设备研发、饮用水水质提升与安全保障、黑臭水体无药剂低能耗治理、水产高密度无抗养殖与品质改善”等方向开展工作。",
  ...
  appointmentsZh: [
    "2025.2–2030.1 天津市宁河区产业高质量发展“领衔专家”",
