...
export const pi: PiInfo = {
  ...
  addr: "天津市津南区海河教育园区雅观路135号，天津大学北洋园校区，邮编：300354",
  bio: `王天志，天津大学环境科学与工程学院副教授(博导)、瑞德智创新技术(天津)有限公司董事长。聚焦微纳米气泡技术领域前沿研究与应用，注重理论创新与技术转化，形成"技术突破商业转化"特色科研体系，构建了完整的微纳米气泡技术自主知识产权体系，创办企业获得主流资本的天使轮投资，融资1550万元，技术估值7000万元。`,
